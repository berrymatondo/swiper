...
const ZoneItem = ({ zone }: ZoneItemProps) => {
  ...
  return (
    <div
      ...
      className="gap-2 flex justify-between shadow-md rounded-lg m-2 bg-gradient-to-r from-blue-100 to-purple-300 hover:cursor-pointer"
    >
      <div
      ...
      >
        ...
        <div className="relative col-span-2 flex flex-col items-start my-2 ml-2 ">
          <p className="text-md font-semibold ">{zone.name}</p>
